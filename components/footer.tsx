    ...
    <footer className="py-8 border-t border-white/10 bg-black">
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="text-white/50 text-sm">© {currentYear} Patrick Kipkoech. All rights reserved.</div>

          <div className="flex space-x-4 mt-4 md:mt-0">
            <a href="https://github.com/koskei-kipkoech" className="text-white/70 hover:text-white transition-colors duration-200">
            ...
            <a href="https://www.linkedin.com/in/patrick-kipkoech/" className="text-white/70 hover:text-white transition-colors duration-200">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
